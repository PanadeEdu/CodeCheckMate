...
class ResultRepository extends FileRepository\AbstractRepository implements FileRepository\RepositoryInterface {

    /**
     * @param array $settings
     */
    public function injectSettings (array $settings) {
        $this->settings = $settings['repository']['resultRepository'];
    }
